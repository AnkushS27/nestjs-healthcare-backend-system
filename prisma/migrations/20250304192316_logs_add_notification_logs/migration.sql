/*
  ...
  - You are about to drop the `FollowUpReminder` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "FollowUpReminder" DROP CONSTRAINT "FollowUpReminder_doctorId_fkey";
